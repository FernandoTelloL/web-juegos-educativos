...
import {  CommunicationGamesGrade1, EntertainmentGrade1, Grade1, Grade2, Grade3, Grade4, Grade5, Grade6, HomePage, InitialGrade, MathGamesGrade1, MathGamesGrade2, MathGamesInitial, MemoryGamesInitial, OtherGamesGrade1 } from '../pages';
    ...
    <Routes>
      <Route element={<MainLayout />} >
        ...
        <Route path="/grade-2" element={<Grade2 />} >
          ...
          <Route path="otros-grade2" element={<OtherGamesGrade1/>} />
