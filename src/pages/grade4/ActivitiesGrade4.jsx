...
import { AllGrade4 } from "./AllGrade4";

export const ActivitiesGrade4 = () => {
  ...
  const categoriesList = [
    ...
    },
    {
      ...
      link: "entretenimiento-grade4",
      bgColor: "bg-red-500",
      bgColorHover: "bg-red-600",
    },
  ];

  const isTodoRoute = location.pathname === "/grade-4" || location.pathname.includes("todo-grade4");
