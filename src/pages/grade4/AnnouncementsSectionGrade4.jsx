...
export const AnnouncementsSectionGrade4 = () => {
  return (
    <section className="mb-14">
      ...
      <div className="w-full">
        ...
        >
          <path
            ...
            stroke="none"
            strokeWidth="0"
            fill="#FF6347"  // Color de la ola es un tono tomate
            fillOpacity="1"
      ...
      <h1 className="text-5xl font-bold text-center mb-12">4° GRADO</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center container px-2 md:w-[80%] mx-auto mt-0 mb-24">
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <h2 className="text-xl font-bold mt-4">Desafíos Mentales</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Pon a prueba tu mente con acertijos y desafíos que te harán pensar como un verdadero genio.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <h2 className="text-xl font-bold mt-4">Exploradores del Conocimiento</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Prepárate para despegar hacia nuevos horizontes en el universo del saber.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <h2 className="text-xl font-bold mt-4">Estrellas en Ascenso</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Brilla como una estrella mientras alcanzas nuevas metas en tu aprendizaje.
          </p>
        </div>
