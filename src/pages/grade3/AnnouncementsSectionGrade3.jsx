...
export const AnnouncementsSectionGrade3 = () => {
  return (
    <section className="mb-14">
      ...
      <div className="w-full">
        ...
        >
          <path
            ...
            stroke="none"
            strokeWidth="0"
            fill="#FF7F50"  // Cambié el color de la ola a un coral vibrante
            fillOpacity="1"
      ...
      <h1 className="text-5xl font-bold text-center mb-12">3° GRADO</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center container px-2 md:w-[80%] mx-auto mt-0 mb-24">
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <h2 className="text-xl font-bold mt-4">Lanzando el Aprendizaje</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            ¡Prepara tu cohete! Vamos a despegar hacia nuevas aventuras de conocimiento y diversión.
          </p>
        </div>

        {/* Segundo ítem */}
        <div className="flex flex-col items-center mt-8">
          <div className="bg-orange-400 text-white p-4 rounded-full">
            <FaLightbulb size={40} />
          </div>
          <h2 className="text-xl font-bold mt-4">Ideas Brillantes</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Enciende la chispa de tu curiosidad con actividades que iluminarán tu camino de aprendizaje.
          </p>
        </div>

        {/* Tercer ítem */}
        <div className="flex flex-col items-center mt-8">
          <div className="bg-lime-500 text-white p-4 rounded-full">
            <FaBook size={40} />
          </div>
          <h2 className="text-xl font-bold mt-4">Lecturas Fascinantes</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Descubre libros llenos de historias y conocimientos que te transportarán a nuevos mundos.
          </p>
        </div>
