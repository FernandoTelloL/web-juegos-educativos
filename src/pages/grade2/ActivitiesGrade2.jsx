...
import { AllGrade2 } from "./AllGrade2";


export const ActivitiesGrade2 = () => {
  ...
  const categoriesList = [
    ...
    },
    {
      ...
      link: "entretenimiento-grade2",
      bgColor: "bg-red-500",
      bgColorHover: "bg-red-600",
    },
  ];

  const isTodoRoute = location.pathname === "/grade-2" || location.pathname.includes("todo-grade2");
