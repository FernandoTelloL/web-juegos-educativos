import { FaCompass, FaLightbulb, FaTrophy } from "react-icons/fa"

export const AnnouncementsSectionGrade5 = () => {
  return (
    <section className="mb-14">
      ...
      <div className="w-full">
        ...
        >
          <path
            ...
            stroke="none"
            strokeWidth="0"
            fill="#32CD32" // Color de la ola es un tono verde lima
            fillOpacity="1"
      ...
      <h1 className="text-5xl font-bold text-center mb-12">5° GRADO</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center container px-2 md:w-[80%] mx-auto mt-0 mb-24">
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            ¡Deja que tu creatividad brille! Comparte tus ideas y observa cómo se transforman en algo increíble.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <h2 className="text-xl font-bold mt-4">Aventuras Inolvidables</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Embárcate en aventuras llenas de descubrimientos que te llevarán a lugares asombrosos.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <h2 className="text-xl font-bold mt-4">Logros Épicos</h2>
          <p className="mt-2 text-lg md:text-normal w-[70%] text-gray-600">
            Celebra tus éxitos y sigue alcanzando nuevas alturas en tu camino hacia la grandeza.
          </p>
        </div>
