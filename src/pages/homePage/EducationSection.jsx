    ...
    <section className="">
      ...
      <div className="w-full">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-auto">
          <path fill="#ffa337" fillOpacity="1" d="M0,64L24,101.3C48,139,96,213,144,224C192,235,240,181,288,144C336,107,384,85,432,80C480,75,528,85,576,122.7C624,160,672,224,720,240C768,256,816,224,864,218.7C912,213,960,235,1008,229.3C1056,224,1104,192,1152,197.3C1200,203,1248,245,1296,240C1344,235,1392,181,1416,154.7L1440,128L1440,0L1416,0C1392,0,1344,0,1296,0C1248,0,1200,0,1152,0C1104,0,1056,0,1008,0C960,0,912,0,864,0C816,0,768,0,720,0C672,0,624,0,576,0C528,0,480,0,432,0C384,0,336,0,288,0C240,0,192,0,144,0C96,0,48,0,24,0L0,0Z"></path>
        </svg>
      </div>
